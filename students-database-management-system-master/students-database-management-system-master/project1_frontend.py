...
class Student:
    ...
    def __init__(self,root):
       ...
       pb.studentData()
       def iExit():
              iExit=tkinter.messagebox.askyesno("Satyam's student dbms","confirm if you want to exit")
              if iExit>0:
                     root.destroy()
                     return
       def clearData():
       ...
       self.lblTit=Label(TitFrame,font=('arial',12),text="(satyam trivedi)",bg="red",fg="black")
       self.lblTit.grid()
